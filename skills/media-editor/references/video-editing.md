# Video editing and export with ffmpeg

Use this reference when the user wants to cut a video, remove sections, speed
up or slow down footage, stitch clips together, or export a final render for
...
After exporting, re-transcribe `final.mp4` (see
[audio-transcribe.md](audio-transcribe.md)) so subtitles and chapter metadata
match the actual edit.
