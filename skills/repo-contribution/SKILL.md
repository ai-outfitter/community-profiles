...
description: Implement an assigned GitHub issue through a pull request, respond to a change request on your own pull request, or independently review a requested pull request, routed on the work item the runtime delivered.
---
...
- The delivered work item owns the subject and the active credential owns the
